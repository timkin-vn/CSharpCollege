...
namespace FifteenGame.WebApi.Controllers
{
    public class GamesController : ApiController
    {
        ...
        {
            var fisrsbuutonRowCol =  request.ParaOneebuutonRowCol;
            var secondbuutonRowCol = request.ParaTwoebuutonRowCol;
           
            var reply = _gameService.Connect_components(request.GameId, fisrsbuutonRowCol,secondbuutonRowCol);
            return ToDto(reply);
        }
