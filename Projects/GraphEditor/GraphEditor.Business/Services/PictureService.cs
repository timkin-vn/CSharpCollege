    ...
    public void UpdateMovingPoint(PointModel loc)
    {
        ...
        switch (selectedRect.EditMode)
        {
            ...
            case EditMode.ResizeL:
                var oldRight = selectedRect.Right;
                selectedRect.Left = loc.X;
                selectedRect.Right = oldRight;
                break;

            case EditMode.ResizeT:
                var oldBottom = selectedRect.Bottom;
                selectedRect.Top = loc.Y;
                selectedRect.Bottom = oldBottom;
                break;
            ...
            case EditMode.ResizeTL:
                var oldRightTL = selectedRect.Right;
                var oldBottomTL = selectedRect.Bottom;
                selectedRect.Left = loc.X;
                selectedRect.Top = loc.Y;
                selectedRect.Right = oldRightTL;
                selectedRect.Bottom = oldBottomTL;
                break;

            case EditMode.ResizeTR:
                var oldLeftTR = selectedRect.Left;
                var oldBottomTR = selectedRect.Bottom;
                selectedRect.Right = loc.X;
                selectedRect.Top = loc.Y;
                selectedRect.Left = oldLeftTR;
                selectedRect.Bottom = oldBottomTR;
                break;

            case EditMode.ResizeBL:
                var oldRightBL = selectedRect.Right;
                var oldTopBL = selectedRect.Top;
                selectedRect.Left = loc.X;
                selectedRect.Bottom = loc.Y;
                selectedRect.Right = oldRightBL;
                selectedRect.Top = oldTopBL;
                break;
