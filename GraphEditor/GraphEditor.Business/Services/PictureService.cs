...
namespace GraphEditor.Business.Services
{
    public class PictureService
    {
        ...
        public void SetFillColor(Color color)
        {
            if (PictureModel.SelectedRectangle != null)
            {
                PictureModel.SelectedRectangle.UseGradient = false;
        ...
        public void SetGradientFill(Color color)
        {
            ...
            {
                PictureModel.SelectedRectangle.FillColor = color;
                PictureModel.SelectedRectangle.GradientColor = Color.White;
                PictureModel.SelectedRectangle.UseGradient = true;
            }
        }
        ...
        public void LastLayer() 
        {
            ...
            var selectedRect = PictureModel.SelectedRectangle;
            PictureModel.Rectangles.Remove(selectedRect);
