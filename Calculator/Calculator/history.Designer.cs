    ...
    partial class history
    {
        ...
        private void InitializeComponent()
        {
            ...
            if (temp_history.Count != 0)
            {
                ...
                this.label1.Text = temp_history[0].toString();
            ...
            if (temp_history.Count > 1)
            {
                ...
                this.label2.Text = temp_history[1].toString();
            ...
            if (temp_history.Count > 2)
            {
                ...
                this.label3.Size = new System.Drawing.Size(281, 64);
                this.label3.TabIndex = 3;
                this.label3.Text = temp_history[2].toString();
            ...
            if (temp_history.Count > 3)
            {
                ...
                this.label4.Size = new System.Drawing.Size(281, 64);
                this.label4.TabIndex = 4;
                this.label4.Text = temp_history[3].toString();
            ...
            if (temp_history.Count > 4)
            {
                ...
                this.label5.Size = new System.Drawing.Size(281, 64);
                this.label5.TabIndex = 5;
                this.label5.Text = temp_history[4].toString();
            ...
            if (temp_history.Count > 5)
            {
                ...
                this.label6.Text = temp_history[5].toString();
