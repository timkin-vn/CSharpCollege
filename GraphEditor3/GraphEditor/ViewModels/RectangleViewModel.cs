...
namespace GraphEditor.ViewModels
{
    internal class RectangleViewModel
    {
        ...
        public FillType FillType { get; set; } = FillType.SolidColor;
        public Color GradientColor1 { get; set; } = Color.Yellow;  
        public Color GradientColor2 { get; set; } = Color.Red;     
            ...
            switch (FillType)
            {
                ...
                case FillType.Gradient:
                    return new LinearGradientBrush(
                        Rectangle, GradientColor1, GradientColor2, LinearGradientMode.Horizontal);
                ...
                case FillType.Texture:
                    if (!string.IsNullOrEmpty(TexturePath) && System.IO.File.Exists(TexturePath))
                    {
                        try
                        {
                            ...
                            textureBrush.TranslateTransform(Rectangle.X, Rectangle.Y);
                        ...
                        {
                            System.Diagnostics.Debug.WriteLine($"Ошибка текстуры: {ex.Message}");
                            return new SolidBrush(FillColor);
                        }
                    }
                    return new SolidBrush(FillColor);
