...
namespace CardFile.Business.Services
{
    public class CardFileService
    {
        ...
        private Card FromDto(CardDto dto)
        {
            ...
            //{
            //    Id = dto.Id,
            //    NameMedication = dto.NameMedication,
            //    TypeMedication = dto.TypeMedication,
            //    DateManufacture = dto.DateManufacture,
            //    DateExpiration = dto.DateExpiration,
            //    CountMedication = dto.CountMedication,
            //    PriceOneMedication = dto.PriceOneMedication,
            //};
        }
        ...
        private CardDto ToDto(Card card)
        {
            ...
            //{
            //     Id = card.Id,
            //    NameMedication = card.NameMedication,
            //    TypeMedication = card.TypeMedication,
            //    DateManufacture = card.DateManufacture,
            //    DateExpiration = card.DateExpiration,
            //    CountMedication = card.CountMedication,
            //    PriceOneMedication = card.PriceOneMedication,
            //};
        }
    }
}
