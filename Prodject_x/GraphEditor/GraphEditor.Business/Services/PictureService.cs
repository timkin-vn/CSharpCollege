...
namespace GraphEditor.Business.Services
{
    public class PictureService
    {
        ...
        public void MoveOnForeground()
        {
            ...
            var r = _model.RectangleList[index];
            for (int i= index; i < _model.RectangleList.Count-1;i++)
            {
                _model.RectangleList[i] = _model.RectangleList[i + 1];
            }
            _model.RectangleList[_model.RectangleList.Count - 1] = r;
        }

        public void MoveOnBackground()
        {
            if (_model.SelectedRectangle == null)
            {
                return;
