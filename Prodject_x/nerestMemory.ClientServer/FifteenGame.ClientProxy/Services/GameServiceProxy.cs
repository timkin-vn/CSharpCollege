...
namespace FifteenGame.ClientProxy.Services
{
    public class GameServiceProxy : IGameService
    {
        ...
        {
            var httpContent = JsonContent.Create(new MakeMoveRequest { GameId = gameId, ParaOneebuutonRowCol = ParaOneebuutonRowCol, ParaTwoebuutonRowCol = ParaTwoebuutonRowCol });
