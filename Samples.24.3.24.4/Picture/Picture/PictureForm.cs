...
namespace Picture
{
    public partial class PictureForm : Form
    {
        ...
        private void PictureForm_Paint(object sender, PaintEventArgs e)
        {
            ...
            //var brush = new LinearGradientBrush(rect, Color.Yellow, Color.Red, LinearGradientMode.BackwardDiagonal);
            //g.FillRectangle(brush, rect);

            //var pen = new Pen(Color.FromArgb(119, 17, 255), 3);
