    ...
    internal class ZipFileSaver : IFileSaver
    {
        public void OpenFile(string fileName, CardCollection collection)
        {
            ...
            using (var archive = new ZipArchive(fs, ZipArchiveMode.Read))
            {
                ...
                {
                    var xmlCollection = (XmlCardCollection)new XmlSerializer(typeof(XmlCardCollection))
                        .Deserialize(reader);
        ...
        public void SaveFile(string fileName, CardCollection collection)
        {
            ...
            using (var archive = new ZipArchive(fs, ZipArchiveMode.Create))
            {
                ...
                {
                    new XmlSerializer(typeof(XmlCardCollection)).Serialize(writer, xmlCollection);
                }
            }
        }
    }
