...
namespace CardFile.Wpf.ViewModels
{
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public string WindowTitle => string.IsNullOrEmpty(FileName) ? "Библиотека" : $"Библиотека: {Path.GetFileName(FileName)}";
        ...
        public CardViewModel GetNewCard()
        {
            ...
            {
                DateOfPublishing = new DateTime(2000, 1, 7),
                DateOfDelisting = new DateTime(2020, 1, 7),
            };
        }
