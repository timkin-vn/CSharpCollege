...
namespace CardFile.Wpf
{
    public partial class MainWindow : Window
    {
        ...
        private void FileOpenMenuItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                Filter = "Текстовые файлы|*.txt|Файлы CSV|*.csv|Двоичные файлы морга|*.cardbin" +
                    "|XML-файлы морга|*.cardxml|JSON-файлы морга|*.cardjson|ZIP-архив морга|*.cardzip",
            };
        ...
        private void CreateButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            ViewModel.SaveNewCard(window.GetViewModel());
        }
        ...
        private void EditButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            ViewModel.SaveEditedCard(window.GetViewModel());
        }
