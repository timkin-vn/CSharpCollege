...
using EllipseEditor.ViewServices;

namespace EllipseEditor
{
    public partial class EllipseEditorForm : Form
    {
        ...
        private EllipseModel _draft;

        public EllipseEditorForm()
        {
            InitializeComponent();
        }
        ...
        private void canvasPanel_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            else
            {
                ...
                _mode = Mode.Draw;
                _draft = _viewService.AddEllipse(e.X, e.Y, 0, 0);
            }
        ...
        private void saveButton_Click(object sender, EventArgs e)
        {
            ...
            {
                dlg.Filter = "Рисунок (*.epic)|*.epic|Все файлы (*.*)|*.*";
                dlg.DefaultExt = "epic";
                if (dlg.ShowDialog(this) == DialogResult.OK)
                {
