...
namespace Calculator
{
    public partial class CalculatorForm : Form
    {
        ...
        private void OnePartNumberButton_Click(object sender, EventArgs e)
        {
            
            string errorMessage = _service.ZeroCheck(_state);
        ...
        {
            _service.RaiseToDegree(_state); 
            DisplayLabel.Text = _state.XRegister.ToString();
        }

        private void SquareButton_Click(object sender, EventArgs e)
        {
            _service.CalculateRoot(_state);
            DisplayLabel.Text = _state.XRegister.ToString();
        }
    }
}
