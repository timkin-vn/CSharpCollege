...
namespace CardFile.Wpf
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void SetupEditWindow(CardEditWindow window)
        {
            window.ViewModel.AvailableHeroes = ViewModel.Heroes;
            window.ViewModel.AvailableItems = ViewModel.Items;
            window.ViewModel.AvailableNeutrals = ViewModel.Neutrals;

            window.ViewModel.AddHeroToDatabase = ViewModel.AddHeroToDatabase;
            window.ViewModel.AddItemToDatabase = ViewModel.AddItemToDatabase;
            window.ViewModel.AddNeutralToDatabase = ViewModel.AddNeutralToDatabase;
        }
    }
}
