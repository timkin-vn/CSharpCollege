    ...
    public class CalculatorService
    {
        ...
        private void CompleteOperation(CalculatorModel calculatorModel)
        {
            switch (calculatorModel.OperationCode)
            {
                ...
                case "^":
                    calculatorModel.RegisterX = (dynamic)Math.Pow((double)calculatorModel.RegisterY, (double)calculatorModel.RegisterX);
                    break;
                ...
                case "√^n":
                    if (calculatorModel.RegisterX != 0)
                        calculatorModel.RegisterX = (dynamic)Math.Pow((double)calculatorModel.RegisterY, 1.0 / (double)calculatorModel.RegisterX);
                    break;
            }
        }
