...
namespace GraphEditor.Business.Services
{
    public class PictureService
    {
        ...
        private readonly Stack<PictureModel> _history = new Stack<PictureModel>();
        private PictureModel ClonePicture()
        {
            var clone = new PictureModel();

            foreach (var r in PictureModel.Rectangles)
            {
                clone.Rectangles.Add(new RectangleModel
                {
                    Left = r.Left,
                    Top = r.Top,
                    Width = r.Width,
        ...
        public void UpdateMovingPoint(PointModel loc)
        {
            ...
            switch (selectedRect.EditMode)
            {
                ...
                case EditMode.ResizeL:
                    selectedRect.Width = selectedRect.Right - loc.X;
                ...
                case EditMode.ResizeT:
                    selectedRect.Height = selectedRect.Bottom - loc.Y;
