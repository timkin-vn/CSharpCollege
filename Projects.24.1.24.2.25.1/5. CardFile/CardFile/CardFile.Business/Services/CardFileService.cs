...
namespace CardFile.Business.Services
{
    public class CardFileService
    {
        ...
        {
            return _collection.GetNeutrals();
        }

        public bool AddHero(string name)
        {
            return _collection.AddHero(name);
        }

        public bool AddItem(string name)
        {
            return _collection.AddItem(name);
        }

        public bool AddNeutral(string name)
        {
            return _collection.AddNeutral(name);
        }
