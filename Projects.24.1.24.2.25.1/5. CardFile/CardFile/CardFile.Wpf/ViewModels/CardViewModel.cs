...
namespace CardFile.Wpf.ViewModels
{
    public class CardViewModel : ViewModelBase
    {
        ...
        public string Fio => $"{LastName}  {MiddleName} {FirstName} ";
        ...
        public string DismissalDateText => DismissalDate?.ToShortDateString() ?? "Активный игрок";
        ...
        public string SalaryText => Salary.ToString("0.00") + " HLTV";
