    ...
    public class CardCollection
    {
        private List<CardDto> _cards = new List<CardDto>
        {
            new CardDto
            {
                ...
                ChildrenCount = 2,
                Email = "loshped228@gmail.com",
                PhoneNumber = 83456572312,
                Address = "ул.Пушкина 85",
                Position = "Менеджер",
                Notes = "Трудоголик",
            },
            new CardDto
            {
                ...
                ChildrenCount = 1,
                Email = "scotina8@gmail.com",
                PhoneNumber = 84638457331,
                Address = "ул.Пушкина 85",
                Position = "Бухгалтер",
                Notes = "Жадная",
            },
            new CardDto
            {
                ...
                ChildrenCount = 3,
                Email = "agape38@gmail.com",
                PhoneNumber = 86574936681,
                Address = "ул.Пушкина 85",
                Position = "Секретарь",
                Notes = "Чистоплотный",
            },
            new CardDto
            {
                ...
                PaymentAmount = 150000m,
                ChildrenCount = 3,
                Email = "irochka4578@gmail.com",
                PhoneNumber = 87564927564,
                Address = "ул.Пушкина 85",
                Position = "Директор",
                Notes = "Умная",
            },
