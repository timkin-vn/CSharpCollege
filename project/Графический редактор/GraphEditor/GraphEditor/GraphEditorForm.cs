...
namespace GraphEditor
{
    public partial class GraphEditorForm : Form
    {
        ...
        private void ResetInterface()
        {
            ...
            BackToolMenuItem.Enabled = _service.DeleteButtonEnabled;
            onForegroundToolStripMenuItem.Enabled = _service.DeleteButtonEnabled;
            onBackgroundToolStripMenuItem.Enabled = _service.DeleteButtonEnabled;
        ...
        private void onForegroundToolStripMenuItem_Click(object sender, EventArgs e)
        {
            _service.MoveOnForeground();
            Refresh();
        }

        private void onBackgroundToolStripMenuItem_Click(object sender, EventArgs e)
        {
            _service.MoveOnBackground();
            Refresh();
        }
