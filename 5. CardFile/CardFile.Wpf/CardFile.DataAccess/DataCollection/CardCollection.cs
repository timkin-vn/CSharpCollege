    ...
    public class CardCollection
    {
        private List<CardDto> _cards = new List<CardDto>
        {
            ...
            new CardDto
            {
                ...
                Salary = 100000m,
                Email = "Lydmila.Viktorovna@gmail.com",
                PhoneNumber = "+7-943-865-99-29",
                Address = "Нижний Новгород, ул. Минина, д. 3",
                IsVerified = true,
            },
            new CardDto
            {
                ...
                Salary = 150000m,
                Email = "Genadii.Andreevich@yandex.ru",
                PhoneNumber = "+7-909-895-83-00",
                Address = "Астрахань, ул. Гагарина, д. 82",
                IsVerified = true,
            },
            new CardDto
            {
                ...
                DismissalDate = null,
                Salary = 150000m,
                Email = "andrey.zakharov@example.com",
                PhoneNumber = "+7-912-345-67-89",
                Address = "Москва, ул. Ленина, д. 1",
                IsVerified = false,
            },
