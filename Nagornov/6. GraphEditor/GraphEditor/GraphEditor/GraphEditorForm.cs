...
namespace GraphEditor
{
    public partial class GraphEditorForm : Form
    {
        ...
        {
            _viewService.CreateRectangleButtonClicked();
            UpdateViewControls();
        }
        ...
        {
            _viewService.CreateCircleButtonClicked();
            UpdateViewControls();
        }

        private void UpdateViewControls()
        {
            CreateRectangleButton.Checked = _viewService.CreateRectangleMode;
            CreateCircleButton.Checked = _viewService.CreateCircleMode;
        ...
        private void changeColorButton_Click(object sender, EventArgs e)
        {
            using (ColorDialog colorDialog = new ColorDialog())
            {
                ...
                {
                    _viewService.ChangeColor(colorDialog.Color);
                    Refresh();
                }
            }
        }
